...
<template>
  <div class="flex flex-col pt-10">
    ...
    <div class="relative basis-full grow">
      ...
      <textarea
        @keydown.enter.prevent
        class="h-28 overflow-hidden w-full py-2 px-2 bg-slate-200 placeholder:text-slate-500 outline-none rounded resize-none transition focus:text-slate-950 text-slate-400"
        type="text"
